...
export const caseStudies: readonly CaseStudy[] = [
  ...
  { slug: 'multi-agent-panel-nutrition-allergy', title: 'Multi-agent panel for nutrition and allergy advice', eyebrow: 'Family health build note', summary: 'How I designed a panel of pediatrician, nutritionist and allergy-specialist agents to help parents organise scattered food reactions, lab results and the questions to ask next.', year: '2026', readingTime: '10 min read', heroMedia: { src: allergyPanelVideo, type: 'video', description: 'Preview of the nutrition and allergy multi-agent panel.' }, externalUrl: null },
