    ...
    <article ref={readerRef} className="blog-reader" aria-labelledby="mamma-calories-blog-title">
            ...
            <div className="blog-reader-body">
              ...
              <section className="blog-copy blog-block">
                ...
                <p>The model stays practical on purpose. A perfect plan on paper is worth nothing if it ignores kitchen capacity, ingredient availability or substitutions. What it does is let the three people involved work from the same numbers.</p>
              </section>
              ...
              <section className="blog-two-column blog-block">
                <div><p className="blog-kicker">Visible product decisions</p><h3 className="blog-heading">Getting from a first look to a usable plan in as few steps as possible.</h3></div>
                <div className="blog-copy">
                  <p>The product puts nutrition-data messaging near the start of the experience so users can understand what the numbers represent. The figures support planning and comparison. The product never presents them as medical advice.</p>
              ...
              <section className="blog-two-column blog-block">
                <div><p className="blog-kicker">Mario's role and build scope</p><h3 className="blog-heading">Product lead from demand research through production build.</h3></div>
                <div className="blog-copy">
                  <p>As product lead working with the founders, Mario took Mamma Calories from zero to one. He analyzed demand, validated the problem with the founders, the market, and early leads, then researched and designed the journey across restaurant, coach and client, and the information hierarchy.</p>
                  <p>Mario built the responsive, database-backed product, including menu discovery, nutrition visibility, weekly plan assembly, target comparison, cost review, and the preparation-request handoff. Every feature listed here works in the live product today.</p>
                </div>
              </section>
              ...
              <section className="blog-copy blog-block">
                ...
                <p>The main lesson was that meal planning needs more than a calculator. It needs coordination. A plan is only useful when it matches a nutrition target to what one specific kitchen can reliably prepare, price and confirm.</p>
              </section>
